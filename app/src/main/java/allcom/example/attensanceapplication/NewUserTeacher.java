...
public class NewUserTeacher extends AppCompatActivity {
    private static final String TAG1 = "TAG";
    EditText tname,Email3,PhoneNumber3,Password3,ReEnterPassword3;
    Button submitbutton;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_new_user_teacher);
            ...
            if (TextUtils.isEmpty(name)){
                ...
                mAuth.createUserWithEmailAndPassword(email,password).addOnCompleteListener(task -> {
                    if (task.isSuccessful()){
                        Toast.makeText(NewUserTeacher.this, "User created.", Toast.LENGTH_LONG).show();
                        ...
                        Intent intent =new Intent(NewUserTeacher.this,Login_Page.class);
                        intent.putExtra("val",1);
                        startActivity(intent);
                    } else {
                        Toast.makeText(NewUserTeacher.this, "ERROR!!! " +task.getException(), Toast.LENGTH_LONG).show();
                    }
                });
            }});
    }
